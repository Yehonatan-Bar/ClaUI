import { FilterInput, FilterOutput, FilterConfig } from '../../extension/particle-accelerator/ParticleAcceleratorTypes';
...
export function buildOutputHeader(
  ...
  return [
    `[claui-particle-accelerator] ${command} ${status} with exit code ${exitCode ?? 'null'} in ${durationSec}s.`,
