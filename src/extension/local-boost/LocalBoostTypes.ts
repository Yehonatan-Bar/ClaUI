...
export interface LocalBoostTrace {
...
export interface LocalBoostTraceSummary {
  traceId: string;
  timestamp: string;
  provider: 'claude' | 'codex';
...
export interface LocalBoostStatus {
  enabled: boolean;
  installed: boolean;
  version: string | null;
...
export interface LocalBoostAggregate {
...
export interface LocalBoostSessionStats {
  commandCount: number;
...
export interface LocalBoostContextFile {
  schemaVersion: number;
  tabRuntimeId: string;
  provider: 'claude' | 'codex';
  workspacePath: string;
...
export interface LocalBoostEnvInput {
...
export interface LocalBoostDailyReport {
  schemaVersion: 1;
  date: string;
  generatedAt: string;
  commandCount: number;
...
export interface LocalBoostRuntimePaths {
  binDir: string;
  runnerJs: string;
  hooksDir: string;
  storeDir: string;
