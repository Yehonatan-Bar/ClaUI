...
import { JavaScriptPackageFilter } from '../../../src/particle-accelerator-runtime/filters/JavaScriptPackageFilter';
import { FilterInput } from '../../../src/extension/particle-accelerator/ParticleAcceleratorTypes';
...
describe('JavaScriptPackageFilter', () => {
  ...
  it('returns a header with command and filter info', () => {
    ...
    assert.ok(result.header.includes('[claui-particle-accelerator]'));
