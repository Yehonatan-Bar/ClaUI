...
import { ParticleAcceleratorContextStore } from '../../src/extension/particle-accelerator/ParticleAcceleratorContextStore';
import { ParticleAcceleratorContextFile, CLAUI_PARTICLE_ACCELERATOR_SCHEMA_VERSION } from '../../src/extension/particle-accelerator/ParticleAcceleratorTypes';
...
describe('ParticleAcceleratorContextStore', () => {
  let tmpDir: string;
  let store: ParticleAcceleratorContextStore;
  ...
  beforeEach(() => {
    tmpDir = makeTempDir();
    store = new ParticleAcceleratorContextStore(tmpDir);
  });
  ...
  describe('createContext', () => {
    it('creates a JSON file with correct fields', async () => {
      ...
      assert.equal(context.schemaVersion, CLAUI_PARTICLE_ACCELERATOR_SCHEMA_VERSION);
  ...
  describe('updateSessionId', () => {
    ...
    it('updates the updatedAt timestamp', async () => {
      ...
      const before: ParticleAcceleratorContextFile = JSON.parse(rawBefore);
      ...
      const after: ParticleAcceleratorContextFile = JSON.parse(rawAfter);
