...
- In provider modes that do not support Git Push, the Git button stays visible but is disabled with a tooltip explanation
...
- In provider modes that do not support Git Push, the gear toggle stays visible but is disabled
